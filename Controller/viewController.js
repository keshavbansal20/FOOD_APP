...
async function getDetailsPage(req , res){
    try{
        ...
        res.render("details" , {momos:momos.discount , burger:burger.discount , pizza:pizza.discount , mojito:mojito.discount , salad:salad.discount , chicken:chicken.discount , healty:healty.discount, aloochaap:aloochaap.discount, coffee:coffee.discout});
    }
    catch(error){
        console.log(error);
    }
